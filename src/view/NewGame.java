...
public class NewGame extends JFrame implements IFrame, INewGame {
	...
	public void initComps() {
		...
		btOnePlayer.setFont(new Font("Tahoma", Font.BOLD, 16));
		btOnePlayer.setForeground(Color.BLACK);
		...
		btTwoPlayer.setFont(new Font("Tahoma", Font.BOLD, 16));
		btTwoPlayer.setForeground(Color.BLACK);
		...
		btBack.setFont(new Font("Tahoma", Font.BOLD, 16));
